...
public class NotificationService {
     ...
     */
    @Transactional
    public void sendNotificationToUser(Long userId, String type, String title, String message, Map<String, Object> data) {
        try {
    ...
    public void notifyServiceProgress(ServiceProgressUpdate update) {
        ...
        String message = String.format("Your %s for vehicle %s is now %s (%d%% complete)",
    ...
    public void notifyProjectRequest(Long userId, Long projectId, String projectName, String status) {
        ...
        String message = String.format("Your modification request '%s' has been %s", projectName, status.toLowerCase());
    ...
    public void broadcastAnnouncement(String title, String message) {
        NotificationMessage announcement = NotificationMessage.builder()
                .type("ANNOUNCEMENT")
                .title(title)
                .message(message)
