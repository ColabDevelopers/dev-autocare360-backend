...
public class MessageService {
    ...
    /**
     * Send a message and notify receiver via WebSocket
     * For customers: receiverId can be NULL (broadcast to all employees)
     * For employees: receiverId is the specific customer ID
     */
    @Transactional
     ...
     * For employees: Shows ALL customer conversations (shared inbox)
    ...
    public List<ConversationDTO> getConversations(Long userId) {
        ...
        if (isEmployee) {
            ...
            for (Long partnerId : partnerIds) {
                ...
                conversation.setRole(partner.getRoles().isEmpty() ? "EMPLOYEE" : 
    ...
    private MessageDTO convertToDTO(Message message, User sender) {
        ...
        dto.setSenderRole(sender.getRoles().isEmpty() ? "USER" : 
            sender.getRoles().iterator().next().getName());
    ...
    /**
     * Get designated employee for customer messaging
     * Returns the first available employee
     */
    @Transactional(readOnly = true)
    public UserSearchDTO getDesignatedEmployee() {
        ...
        return new UserSearchDTO(
            ...
            employee.getName(),
            employee.getEmail(),
            employee.getRoles().isEmpty() ? "EMPLOYEE" : 
