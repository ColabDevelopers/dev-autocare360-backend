...
public class TimeLog {
    ...
    public TimeLog(Employee employee, Appointment appointment, LocalDate date, BigDecimal hours, String description) {
        this();
    ...
    public String getCustomerName() {
        return appointment != null && appointment.getUser() != null ? appointment.getUser().getName() : null;
    }
