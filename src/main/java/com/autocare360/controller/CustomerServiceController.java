...
public class CustomerServiceController {
    ...
    /**
     * Get all services/appointments for the authenticated customer
     * Organized by status with full details
     */
    @GetMapping("/services")
    public ResponseEntity<Map<String, Object>> getCustomerServices(Authentication authentication) {
        try {
            ...
            List<CustomerServiceDTO> serviceDTOs = appointments.stream()
    ...
    private List<CustomerServiceDTO> filterByStatus(List<CustomerServiceDTO> services, String... statuses) {
        return services.stream()
                .filter(s -> {
                    String serviceStatus = s.getStatus() != null ? s.getStatus().toUpperCase() : "SCHEDULED";
    ...
    private Map<String, Object> createEmptyResponse() {
        ...
        response.put("categorized", Map.of(
    ...
    private CustomerServiceDTO convertToDTO(Appointment appointment) {
        ...
        dto.setCreatedAt(appointment.getCreatedAt() != null ? appointment.getCreatedAt().toString() : null);
        dto.setUpdatedAt(appointment.getUpdatedAt() != null ? appointment.getUpdatedAt().toString() : null);
