...
public class EmployeeDashboardSummaryDTO {
    ...
    public EmployeeDashboardSummaryDTO(Integer activeJobs, Integer jobsInProgress, BigDecimal todayHours,
                                       BigDecimal targetHours, Integer completedThisMonth, BigDecimal efficiencyRate,
                                       String employeeName, String greeting) {
